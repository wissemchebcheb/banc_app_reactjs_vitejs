...
const Billing = () =>  (
    <div>
      <section id='product' className={layout.sectionReverse}> 
        ...
        <div className='absolute z-[3] -left-1/2 top-0 w-[25%] h-[25%]rounded-full white__gradient'/>
        <div className='absolute z-[0] -left-1/2 bottom-0 w-[25%] h-[25%] rounded-full pink__gradient'/>
        </div>
